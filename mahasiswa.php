...
if (isset($_POST['simpan'])) {
    ...
    if ($nim && $nama && $alamat && $jurusan_id && $namajurusan ) {
        $sql1 = "insert into mahasiswa (nim,nama,alamat,namajurusan,jurusan_id) values ('$nim','$nama','$alamat','$namajurusan','$jurusan_id')";
...
<body>
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="namajurusan" id="namajurusan">
                            <?php
    echo "<option value = $data[id]>$data[namajurusan]</option>";
    $query = mysqli_query($koneksi,"SELECT * FROM jurusan") or die (mysqli_error($koneksi));
    ...
    ?>
                    ...
                    <div class="col-12">
                        <input type="submit" name="proses" value="Simpan data" class="btn btn-primary" />
                    </div>
                    <?php
                    if(isset($_POST['proses'])) {
                        ...
                        nim = '$nim' 
                        nama = '$nama'
                        alamat = '$alamat' where id=$_GET[update]") or die (mysqli_error($koneksi));
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th scope="row">><?php echo $jurusan_id?></th>
                                    <td scope="row">
