...
if (isset($_POST['simpan'])) {
    ...
    if ($nim && $nama && $alamat && $namafakultas && $namajurusan) {
        $sql1 = "insert into siswa (nim,nama,alamat,namafakultas,namajurusan) values ('$nim','$nama','$alamat','$namafakultas', '$namajurusan')";
        $q1   = mysqli_query($koneksi, $sql1);
        if ($q1) {
